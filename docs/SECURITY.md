...
## 1. OWASP TOP 10 - PREVENTION PRINCIPLES

### 1.1 Broken Access Control (A01:2021)

```typescript
// REQUIRED: Middleware authorization check
// src/middleware.ts
...
// Password hashing (bcrypt, DO NOT use md5/sha1)
...
// Token generation (crypto.randomBytes, DO NOT use Math.random)
...
```typescript
// CORRECT: Parameterized queries (Prisma built-in)
...
> **IMPORTANT**: Security is not optional. All rules above are MANDATORY.
> Violation = Critical bug = Fix immediately.
